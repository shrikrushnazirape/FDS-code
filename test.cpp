...
#include<ctype.h>
using namespace std;
//class Operations containing data member and member functions
class Operations
{
...
void Operations::postfixExpEval() //To evaluate the postfix expression
{
    i=0;
    char ch;
    int op1,op2,res,tot;
...
int Operations::incomingprio(char ch)
{
    switch(ch)
    {
     case '(':return 9; break;
